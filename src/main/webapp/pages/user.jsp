...
<div class="container-fluid" id="user-screen">
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        ...
        <div class="form-inline pull-right" id="login-bar">
            ...
            <a href="${pageContext.request.contextPath}/site/create_request" class="btn btn-success"><i
                    ></i> Создать реквест</a>
            ...
            <ul class="list-unstyled activity-table">
                ...
                <li class="activity-item">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="activity-bar">
                                <ul class="list-inline">
                                    <li>
                                        <small>Создано: <c:out value="${activity.dateStart}"/></small>
                                    </li>
                                    <li>
                                        <small><c:out value="${activity.status}"/></small>
                                    </li>
                        ...
                        <c:if test="${activity.status eq 'DURING'}">
                        <div class="col-sm-4">
                            <form method="post" action="${pageContext.request.contextPath}/site/finish">
                                <input type="number" hidden name="activityId" value="${activity.id}"/>
                                <button type="submit" class="btn btn-outline-primary btn-sm "> Закончить активность
                                </button>
                            </form>
                        </div>
                        </c:if>
