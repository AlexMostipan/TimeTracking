        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            ...
            <div class="row" style="margin-right:0;">
                ...
                <div class="col-sm-10">
                    ...
                    <form method="POST">
                      <c:forEach var="activityRequest" items="${requestScope.allRequest}">
                        <li class="activity-item">
                            <div class="row">
                                <!--Активность начало-->
                                <div class="col-sm-8">
                                    <h4><c:out value="${activityRequest.user.username}"/></h4>
                                    <p><c:out value="${activityRequest.requestType}"/></p>
                                            <ul class="list-inline">
                                            <li><small>Создано: <c:out value="${activityRequest.creationDate}"/></small></li>
